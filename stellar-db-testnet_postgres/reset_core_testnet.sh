...
rm -r ./buckets
rm -r ./tmp
echo " database in postgres must be mannually cleared in this one at this time."
#rm ./stellar.db-shm
#rm ./stellar.db-wal
rm ./stellar-core.log
...
#taskset --cpu-list 1,2 $COREPATH/stellar-core -conf $CONFIGFILE
#taskset --cpu-list 2 $COREPATH/stellar-core -conf $CONFIGFILE
